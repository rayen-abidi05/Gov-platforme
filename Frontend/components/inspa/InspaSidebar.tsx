...
const NAV_ITEMS = [
  { href: "/inspa", label: "Tableau de bord", icon: LayoutDashboard },
  { href: "/inspa/assigned", label: "Inspections assignées", icon: ClipboardList },
  { href: "/inspa/pending", label: "En attente", icon: Clock },
  { href: "/inspa/completed", label: "Terminées", icon: CheckCircle2 },
  { href: "/inspa/history", label: "Historique", icon: History },
  { href: "/inspa/notifications", label: "Notifications", icon: Bell },
  { href: "/inspa/profile", label: "Profil", icon: UserCircle },
];
  ...
  return (
    <aside className="hidden w-64 shrink-0 border-r border-cream-50/10 bg-olive-950/60 backdrop-blur-md lg:flex lg:flex-col">
      ...
      <div className="border-t border-cream-50/10 px-6 py-4">
        <p className="text-xs text-cream-50/40">Accès inspecteur INSPA</p>
      </div>
    </aside>
  );
}
